...
- (void)handleSendMessage:(INSendMessageIntent *)intent completion:(void (^)(INSendMessageIntentResponse *response))completion {
    ...
    [usrInfo setValue:siriInputedData forKey:@"siriInputedData"];
    [usrInfo synchronize];
...
- (void)handleSearchForMessages:(nonnull INSearchForMessagesIntent *)intent completion:(nonnull void (^)(INSearchForMessagesIntentResponse * _Nonnull))completion {
    
}

- (void)handleSetMessageAttribute:(nonnull INSetMessageAttributeIntent *)intent completion:(nonnull void (^)(INSetMessageAttributeIntentResponse * _Nonnull))completion {
